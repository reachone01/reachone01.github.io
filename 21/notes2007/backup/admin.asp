...
<td style="text-align:left;"><a href="addform.asp">AddRecord</a>  </td>
  ...
  <td colspan="2"> <a href="一元二次方程求解.html" target="_blank"> 一元二次方程求解</a><span class="time"></span></td>
...
%> <tr>
      <td><%=(Recordset1.Fields.Item("summary").Value)%></td>
...
<col width="30%" />
  ...
  <tr>
  <td style="text-align:left;">&nbsp;<a href="http://www.iciba.com" target="_blank">iciba</a></td>
