...
If (CStr(Request("MM_update")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_fieldsStr  = "summary|value|content|value"
  MM_columnsStr = "summary|',none,''|content|',none,''"
...
<form method="POST" action="<%=MM_editAction%>" name="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="summary" value="<%=(Recordset1.Fields.Item("summary").Value)%>" size="40">
      </td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">Content:</td>
      <td><textarea name="content" cols="90" rows="25"><%=(Recordset1.Fields.Item("content").Value)%></textarea>
      </td>
    </tr>
    <tr valign="baseline">
