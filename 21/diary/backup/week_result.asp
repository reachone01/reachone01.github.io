...
Recordset1.Source = "SELECT *  FROM news  WHERE week like '%" + Replace(Recordset1__MMColParam, "'", "''") + "%'  ORDER BY vtime DESC"
...
<table width="80%" border="0" align="center">
  <tr>
    <td style="text-align:left; color:#993333; font-weight:bold;">提示:您查询的是列"week"中的内容,模糊匹配:"<%=Recordset1__MMColParam%>"</td>
  </tr>
</table>
