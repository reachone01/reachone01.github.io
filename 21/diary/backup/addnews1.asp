...
<form ACTION="<%=MM_editAction%>" METHOD="POST" id="form1" name="form1">
  <table width="50%" border="0" align="center">
    ...
    <tr>
      <td>week:</td>
      <td colspan="3"><input name="week" type="text" id="week" value="<% dim mya :mya=array("函数WeekDay(date)值1－7对应Sun.,Mon. ...;而数组下标是以0开始的","Sun.","Mon.","Tue.","Wed.","Thur.","Fri.","Sat.") :response.Write(mya(WeekDay(date))) %>" size="5" /></td>
    </tr>
    <tr>
      <td>weather:</td>
    ...
    <tr>
      <td colspan="2" style="text-align:left;"><a href="http://php.weather.sina.com.cn/search.php?city=广州" target="_blank">广州天气</a>&nbsp;<a href="http://www.iciba.com" target="_blank">iciba</a></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
  </table>
